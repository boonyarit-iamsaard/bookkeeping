...
The closing note's leftovers are now accounted for. The delete dialog stopped
moving on its own curve in 17 (4770068), so it now slides only as a sheet.
The button press nudge is filed as 21.
